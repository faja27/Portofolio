...
(function() {
  const patch = {
    en: {
      ...
      'proj.xau.title': 'XAUBot — Gold Trading Bot',
      'proj.xau.desc': 'An ML/AI-based automated trading bot for XAUUSD (Gold/USD) on MetaTrader 5, combining Range Breakout, EMA trend filter, RSI momentum, and ATR volatility — optimized from 81 combinations over 6 years of data with 72.1% win rate and 2.71 profit factor.',
    ...
    id: {
      ...
      'proj.xau.title': 'XAUBot — Bot Trading Emas',
      'proj.xau.desc': 'Bot trading berbasis ML/AI untuk XAUUSD (Emas/USD) di MetaTrader 5, menggabungkan Range Breakout, filter tren EMA, momentum RSI, dan volatilitas ATR — dioptimalkan dari 81 kombinasi selama 6 tahun data dengan win rate 72,1% dan profit factor 2,71.',
