...
(function() {
  const patch = {
    en: {
      ...
      'cert.genaibiz.desc': 'Industry-recognized certification in Generative AI fundamentals and business applications, issued by CertNexus — a globally accredited IT certification body.',
      ...
      'cert.bisaai.desc': 'Completed intensive on-the-job training in Data Science, verified by Lembaga Pelatihan Kerja (LPK) &amp; Lembaga Kursus dan Pelatihan (LKP) Bisa AI Academy.',
      'cert.itpm.name': 'IT Project Management',
      'cert.itpm.desc': 'Workshop on Software Project Management Lifecycle and Knowledge Area. Covers Project Management Framework, Process, Integration Management, and Professional Responsibility. Average score: 80.5.',
      ...
      'cert.dta1.desc': 'Government-issued training certification covering Python, Pandas, Numpy, Scikit-Learn, Data Scraping, Data Exploration, and Data Cleansing. Organized by Pusat Pengembangan Talenta Digital, Komdigi.',
      'cert.dta2.name': 'Data Scientist Supervisor',
      'cert.dta2.desc': 'Advanced training certification covering Data Screening, Data Object Analysis, Model Design Strategy, Model Implementation, and Model Evaluation. Issued by Komdigi.',
      // projects
      'proj.desc': 'A collection of AI/ML systems, data pipelines, and applied research projects.',
    ...
    id: {
      ...
      'cert.genaibiz.name': 'GenAIBIZ',
      'cert.genaibiz.desc': 'Sertifikasi yang diakui industri dalam dasar-dasar Generative AI dan aplikasi bisnis, diterbitkan oleh CertNexus — badan sertifikasi IT terakreditasi global.',
      'cert.intelligo.name': 'Bootcamp Kecerdasan Buatan — Program Lanjutan',
      'cert.intelligo.score': 'Nilai: 82.75 · Grade: Good',
      'cert.bisaai.name': 'Master Class On Job Training: Data Science',
      'cert.bisaai.desc': 'Menyelesaikan pelatihan on-the-job intensif di bidang Data Science, diverifikasi oleh Lembaga Pelatihan Kerja (LPK) &amp; Lembaga Kursus dan Pelatihan (LKP) Bisa AI Academy.',
      'cert.itpm.name': 'Manajemen Proyek IT',
      'cert.itpm.desc': 'Workshop tentang Siklus Hidup dan Area Pengetahuan Manajemen Proyek Perangkat Lunak. Mencakup Kerangka Manajemen Proyek, Proses, Manajemen Integrasi, dan Tanggung Jawab Profesional. Nilai rata-rata: 80.5.',
      ...
      'cert.dta1.name': 'Associate Data Scientist + Python',
      'cert.dta1.desc': 'Sertifikat pelatihan resmi pemerintah mencakup Python, Pandas, Numpy, Scikit-Learn, Data Scraping, Eksplorasi Data, dan Data Cleansing. Diselenggarakan oleh Pusat Pengembangan Talenta Digital, Komdigi.',
      'cert.dta2.name': 'Data Scientist Supervisor',
      'cert.dta2.desc': 'Sertifikat pelatihan lanjutan mencakup Data Screening, Analisis Objek Data, Strategi Perancangan Model, Penerapan Pemodelan, dan Evaluasi Hasil Pemodelan. Diterbitkan oleh Komdigi.',
      // projects
      'proj.desc': 'Kumpulan sistem AI/ML, pipeline data, dan proyek riset terapan.',
